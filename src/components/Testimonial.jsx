...
function Testimonial() {
  const testimonials = [
    {
      name: 'Abel Mark',
      position: 'shoe making',
      feedback:
        'The vocational training program was amazing. The instructors are very knowledgeable!',
    ...
    {
      name: 'Israel Oluwafemi',
      position: 'Graphic Design', 
      feedback:
        'The support and job placement assistance I received were top-notch!',
